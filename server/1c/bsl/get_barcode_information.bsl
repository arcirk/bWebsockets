	...
	СтруктураШтрихкод = Новый Структура("_id,first,second,ref,barcode,parent,is_group,deletion_mark,version");
	...
	СтруктураНоменклатура = Новый Структура("_id,first,second,ref,cache,parent,vendor_code,is_group,deletion_mark,version");
